...
(*[baz] has infinite elements, because we can keep nesting [Baz1] constructors indefinitely,
and there are two possible boolean values for each [Baz2] constructor.*)
