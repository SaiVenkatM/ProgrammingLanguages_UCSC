...
(** Before getting started on this chapter, we need to import
    ...
    (** To prove interesting facts about numbers, lists, and other
        ...
        principle: _induction_. In Coq, the steps are the same: we begin with the goal of proving
    ...
    *)
    ...
    (** In Coq, as in informal mathematics, large proofs are often
        broken into a sequence of theorems, with later proofs referring town top-level name.  In such
